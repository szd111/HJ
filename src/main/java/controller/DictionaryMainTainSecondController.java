 ...
 * @创建人 rduan
 * @创建时间 2018/10/17
 * @描述 针对windows界面中的字典维护中的 我军装备的actionformed进行事件的控制
 */
public class DictionaryMainTainSecondController {
    ...
    /**
     * @描述 退出界面操作 通过鼠标点击退出键进行退出 我军装备的维护
     * @参数 JFrame窗体
     * @返回值 null
     * @创建人 rduan
     * @创建时间 2018/10/17
    ...
    public void armySituation(final Windows w) {
        ...
        jt.addTreeSelectionListener(new TreeSelectionListener() {
            ...
            public void valueChanged(TreeSelectionEvent e) {
                ...
                ResultSet r = d.executeQuery("select * from scott.字典_通用_装备 where 装备名称='" + object.toString() + "'", c);
                try {
                    r.next();
                ...
                try {
                    ...
                    jname4.setText(r.getObject("计量单位") + "");
                    ...
                    jname11.setText(r.getObject("保留内码") + "");
                    ...
                    jname12.setText(r.getObject("保留序号") + "");
                    ...
                    jname13.setText(r.getObject("保留名称") + "");
